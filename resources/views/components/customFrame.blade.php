            ...
            <div class="space-y-8">
                <div class="space-y-6">
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            <h3 class="text-xl font-semibold text-gray-900 mb-2">Desain Sesuai Keinginan</h3>
                            <p class="text-gray-600">Frame custom dibuat khusus untuk acara pernikahan, ulang tahun,
                                wisuda, atau event spesial lainnya</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">Desain berkualitas tinggi dengan resolusi terbaik untuk hasil
                                foto yang sempurna</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="relative bg-white rounded-2xl p-8 custom-shadow">
                    <div class="text-center">
                        ...
                        <div class="mt-6 flex items-center justify-center space-x-4 text-sm text-gray-500">
                            ...
                            <div class="flex items-center">
                                <div class="w-2 h-2 bg-[#BF3131] rounded-full mr-2"></div>
                                Gratis konsultasi
                            </div>
                        </div>
                    </div>
        ...
        <div class="mt-16">
                    ...
                    @foreach ($customFrames as $frame)
                        <div class="group">
                            <div
                                ...
                                <div
                                    class="aspect-square bg-gray-100 rounded-lg mb-3 flex items-center justify-center overflow-hidden">
                                    @if ($frame->image_path)
                                ...
                                <p class="text-sm font-medium text-gray-700 text-center">{{ $frame->name }}</p>
                            </div>
                        </div>
                    @endforeach
                </div>
            @else
                <div class="text-center py-12 bg-white rounded-lg shadow-md">
                    ...
                    <p class="text-lg text-gray-600">Belum ada frame custom tersedia saat ini.</p>
                    <p class="text-sm text-gray-500 mt-2">Hubungi kami untuk membuat frame custom Anda!</p>
                </div>
            @endif
        </div>
    </div>
...
<style>
    ...
    .custom-shadow {
        box-shadow: 0 10px 25px rgba(191, 49, 49, 0.1);
    }

    .gradient-bg {
        background: linear-gradient(135deg, #BF3131 0%, #F16767 100%);
    }
