    ...
    <div class="max-w-7xl mx-auto h-full">
        <div class="flex justify-between h-full">
            <div class="flex items-center justify-between w-full">
                <div class="flex-shrink-0 flex items-center" data-aos="fade-down" data-aos-delay="100">
                    <a href="{{ route('home') }}" class="text-2xl font-bold text-[#BF3131]">
                        <img src="{{ asset('logo.png') }}" alt="Logo"
                            class="h-12 sm:h-16 md:h-[80px] w-auto mx-auto">
                    </a>
                </div>
                <div class="flex items-center gap-2 sm:gap-5" data-aos="fade-down" data-aos-delay="100">
                    <a href="{{ route('home') }}"
                        ...
                        Home
                        <span
                            class="absolute bottom-0 left-0 w-full h-0.5 bg-[#BF3131] transform scale-x-0 origin-left transition-transform duration-300 ease-in-out group-hover:scale-x-100 active:scale-x-100"></span>
                    </a>
