<div class="w-full h-full relative bg-white overflow-hidden shadow-[0_0_20px_rgba(0,0,0,0.3)]">
     <img src="{{ asset('choco/choco1.png') }}" 
    ...
    <div class="absolute top-[280px] left-[10px] w-[calc(100%-20px)] h-[120px]" data-photo-index="2">
       ...
       <div class="absolute z-[30] bottom-[200px] left-2 w-full text-center pointer-events-none">
        <img src="{{ asset('choco/choco4.png') }}" alt="c4" style="transform: translateX(-20px);" class="h-[80px] w-auto">
    </div>
    ...
    <div class="absolute z-[30] bottom-[450px] left-2 w-full text-center pointer-events-none">
        <img src="{{ asset('choco/choco4.png') }}" alt="c4" style="transform: translateX(-20px);" class="h-[50px] w-auto">
    </div>

    <div class="absolute z-[30] bottom-[320px] left-2 w-full text-center pointer-events-none">
        <img src="{{ asset('choco/choco4.png') }}" alt="c4" style="transform: translateX(120px);" class="h-[90px] w-auto">
    </div>

        <div class="absolute z-[30] bottom-[85px] left-2 w-full text-center pointer-events-none">
        <img src="{{ asset('choco/choco4.png') }}" alt="c4" style="transform: translateX(140px);" class="h-[50px] w-auto">
    </div>

<div class="absolute z-[30] bottom-[-40px] left-2 w-full text-center pointer-events-none">
    <img src="{{ asset('choco/choco5.png') }}" alt="c5"
