<div class="w-full h-full relative bg-white overflow-hidden shadow-[0_0_20px_rgba(0,0,0,0.3)]">
    <img src="{{ asset('mofusan/bg-mofusan.png') }}" class="w-[190px] h-[500px] opacity-80 z-10" />

    <div class="absolute z-[30] top-[65px] left-[-20px] pointer-events-none">
        <img src="{{ asset('mofusan/mofusan1.png') }}" alt="Logo" class="h-[80px] w-auto">
    </div>
    <div class="absolute z-[30] top-[20px] right-[10px] pointer-events-none">
        <img src="{{ asset('mofusan/mofusan2.png') }}" alt="Logo" class="h-[20px] w-auto">
    </div>
    <!-- First Photo Slot -->
    ...
    <div class="absolute z-[30] top-[275px] left-[10px] pointer-events-none">
        <img src="{{ asset('mofusan/mofusan2.png') }}" alt="Logo" class="h-[20px] w-auto">
    </div>
    <div class="absolute z-[30] top-[125px] right-[-10px] pointer-events-none">
        <img src="{{ asset('mofusan/mofusan3.png') }}" alt="Logo" class="h-[70px] w-auto ">
    </div>
    <div class="absolute z-[40] top-[175px] left-[-40px] pointer-events-none">
        <img src="{{ asset('mofusan/mofusan4.png') }}" alt="Logo" class="h-[85px] w-auto ">
    </div>
    ...
    <div class=" z-[40] relative bottom-[175px] right-[-75px] pointer-events-none ">
        <img src="{{ asset('mofusan/mofusan5.png') }}" alt="Logo" class="h-[100px] w-auto mx-auto ">
    </div>
