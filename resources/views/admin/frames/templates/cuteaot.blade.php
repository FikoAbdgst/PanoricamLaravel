<div class="w-full h-full relative bg-overflow-hidden shadow-[0_0_20px_rgba(0,0,0,0.3)]">
    ...
    <div class="absolute z-[30] bottom-[100px] left-2 w-full text-center pointer-events-none">
        <img src="{{ asset('AoT/cuteaot.png') }}" alt="Nj3" style="transform: translateX(-60px);"
