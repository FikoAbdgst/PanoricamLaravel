<div class="w-full h-full relative bg-white overflow-hidden shadow-[0_0_20px_rgba(0,0,0,0.3)]">
    ...
    <div class="absolute top-[280px] left-[10px] w-[calc(100%-20px)] h-[120px]" data-photo-index="2">
        ...
        <img src="{{ asset('music/music3.png') }}" alt="Nj1" style="transform: translateX(2.5px);" class="h-[170px] w-auto">
    </div>
        <div class="absolute z-[30] bottom-[205px] left-2 w-full text-center pointer-events-none">
        <img src="{{ asset('music/music1.png') }}" alt="Nj1" style="transform: translateX(2.5px);" class="h-[170px] w-auto">
    </div>
