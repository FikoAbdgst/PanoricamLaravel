<div class="w-full h-full relative bg-white overflow-hidden shadow-[0_0_20px_rgba(0,0,0,0.3)]">
    <img src="{{ asset('bgoliver.png') }}" class="w-[190px] h-[500px] opacity-80 z-10" />
    ...
    <div class="absolute z-[30] bottom-[335px] left-2 w-full text-center pointer-events-none">
        <img src="{{ asset('music/music3.png') }}" alt="Nj1" style="transform: translateX(2.5px);"
            class="h-[170px] w-auto">
    </div>
    <div class="absolute z-[30] bottom-[205px] left-2 w-full text-center pointer-events-none">
        <img src="{{ asset('music/music1.png') }}" alt="Nj1" style="transform: translateX(2.5px);"
            class="h-[170px] w-auto">
    </div>
    ...
    <div class="absolute z-[30] bottom-[-30px] left-2 w-full text-center pointer-events-none">
        <img src="{{ asset('music/music2.png') }}" alt="Nj7"
            class="w-[150px] mx-auto drop-shadow-[0_0px_0px_rgba(255,105,180,0.5)] transition-transform duration-300 hover:scale-105"
