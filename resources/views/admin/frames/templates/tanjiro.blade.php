<div class="w-full h-full relative bg-overflow-hidden shadow-[0_0_20px_rgba(0,0,0,0.3)]">
    <img src="{{ asset('demonslayer/bg-tanjiro.png') }}" class="w-[190px] h-[500px] opacity-80 z-10" />
    ...
    <div class="absolute z-[30] bottom-[350px] left-2 w-full text-center pointer-events-none">
        <img src="{{ asset('demonslayer/tan2.png') }}" alt="Nj2" style="transform: translateX(122px);"
            class="h-[85px] w-auto">
    </div>

    <div class="absolute z-[30] bottom-[85px] left-2 w-full text-center pointer-events-none">
        <img src="{{ asset('demonslayer/tan3.png') }}" alt="Nj2" style="transform: translateX(118px);"
            class="h-[90px] w-auto">
    </div>

    <div class="absolute z-[30] bottom-[180px] left-2 w-full text-center pointer-events-none">
        <img src="{{ asset('demonslayer/tan1.png') }}" alt="Nj3" style="transform: translateX(-30px);"
