<div class="w-full h-full relative bg- overflow-hidden shadow-[0_0_20px_rgba(0,0,0,0.3)]">
    <img src="{{ asset('demonslayer/bg-inosuke.jpg') }}" 
    ...
    <div class="absolute z-[30] bottom-[350px] left-2 w-full text-center pointer-events-none">
        <img src="{{ asset('demonslayer/ino2.png') }}" alt="Nj2" style="transform: translateX(125px);" class="h-[95px] w-auto">
    </div>

    <div class="absolute z-[30] bottom-[85px] left-2 w-full text-center pointer-events-none">
        <img src="{{ asset('demonslayer/ino1.png') }}" alt="Nj2" style="transform: translateX(118px);" class="h-[90px] w-auto">
    </div>

    <div class="absolute z-[30] bottom-[180px] left-2 w-full text-center pointer-events-none">
        <img src="{{ asset('demonslayer/ino3.png') }}" alt="Nj3" style="transform: translateX(-40px);" class="h-[110px] w-auto">
    </div>
