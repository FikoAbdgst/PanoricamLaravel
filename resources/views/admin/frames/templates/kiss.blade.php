<div class="w-full h-full relative bg-white overflow-hidden shadow-[0_0_20px_rgba(0,0,0,0.3)]">
    <img src="{{ asset('kiss/bg-kiss.png') }}" class="w-[190px] h-[500px] opacity-80 z-10" />

    <div class="absolute z-[30] top-[-2px] left-[-1px] pointer-events-none">
        <img src="{{ asset('kiss/kiss1.png') }}" alt="Logo" class="h-[70px] w-auto">
    </div>
    ...
    <div class="absolute z-[30] top-[135px] right-[-1px] pointer-events-none">
        <img src="{{ asset('kiss/kiss1.png') }}" alt="Logo" class="h-[70px] w-auto scale-x-[-1] ">
    </div>
    ...
    <div class="absolute z-[30] bottom-[170px] left-[-1px] pointer-events-none">
        <img src="{{ asset('kiss/kiss1.png') }}" alt="Logo" class="h-[70px] w-auto ">
    </div>
