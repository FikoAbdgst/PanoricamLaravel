<div class="w-full h-full relative bg- overflow-hidden shadow-[0_0_20px_rgba(0,0,0,0.3)]">
    <img src="{{ asset('demonslayer/bg-ds1.jpg') }}" 
    ...
    <div class="absolute z-[30] bottom-[360px] left-2 w-full text-center pointer-events-none">
        <img src="{{ asset('demonslayer/tulisan-ds.png') }}" alt="Nj1" style="transform: translateX(-30px);" class="h-[120px] w-auto">
    </div>

    <div class="absolute z-[30] bottom-[350px] left-2 w-full text-center pointer-events-none">
        <img src="{{ asset('demonslayer/ds4.png') }}" alt="Nj2" style="transform: translateX(122px);" class="h-[85px] w-auto">
    </div>

    <div class="absolute z-[30] bottom-[95px] left-2 w-full text-center pointer-events-none">
        <img src="{{ asset('demonslayer/ds3.png') }}" alt="Nj2" style="transform: translateX(120px);" class="h-[85px] w-auto">
    </div>

    <div class="absolute z-[30] bottom-[210px] left-2 w-full text-center pointer-events-none">
        <img src="{{ asset('demonslayer/ds2.png') }}" alt="Nj3" style="transform: translateX(-30px);" class="h-[80px] w-auto">
    </div>

        <div class="absolute z-[30] bottom-[455px] left-2 w-full text-center pointer-events-none">
        <img src="{{ asset('demonslayer/logo-ds.png') }}" alt="Nj3" style="transform: translateX(145px);" class="h-[30px] w-auto">
    </div>


<div class="absolute z-[30] bottom-[-30px] left-2 w-full text-center pointer-events-none">
    <img src="{{ asset('demonslayer/ds1.png') }}" alt="Nj7"
     class="w-[170px] mx-auto transition-transform duration-300 hover:scale-105"
