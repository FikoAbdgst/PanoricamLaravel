<div class="w-full h-full relative bg-white overflow-hidden shadow-[0_0_20px_rgba(0,0,0,0.3)]">
    <img src="{{ asset('dinojo/bg-dinojo.png') }}" class="w-[190px] h-[500px] opacity-80 z-10" />

    <div class="absolute z-[30] top-[5px] left-[10px] pointer-events-none">
        <img src="{{ asset('roses/roses1.png') }}" alt="Logo" class="h-[170px] w-auto">
    </div>

    <div class="absolute z-[30] top-[7px] left-[-35px] pointer-events-none">
        <img src="{{ asset('dinojo/dinojo3.png') }}" alt="Logo" class="h-[75px] w-auto">
    </div>
    <!-- First Photo Slot -->
    ...
    <div class="absolute z-[30] top-[133px] left-[10px] pointer-events-none">
        <img src="{{ asset('roses/roses1.png') }}" alt="Logo" class="h-[170px] w-auto">
    </div>
    <div class="absolute z-[30] top-[120px] right-[-35px] pointer-events-none">
        <img src="{{ asset('dinojo/dinojo2.png') }}" alt="Logo" class="h-[80px] w-auto ">
    </div>
    ...
    <div class="absolute z-[30] bottom-[70px] left-[10px] pointer-events-none">
        <img src="{{ asset('roses/roses1.png') }}" alt="Logo" class="h-[170px] w-auto">
    </div>
    <div class="absolute z-[30] bottom-[170px] left-[-25px] pointer-events-none">
        <img src="{{ asset('dino/dino2.png') }}" alt="Logo" class="h-[75px] w-auto ">
    </div>
    <div class="absolute z-[30] bottom-[40px] right-[-35px] pointer-events-none">
        <img src="{{ asset('dinojo/dinojo1.png') }}" alt="Logo" class="h-[115px] w-auto ">
    </div>
