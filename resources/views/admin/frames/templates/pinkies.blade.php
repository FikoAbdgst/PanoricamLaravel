<div class="w-full h-full relative bg-white overflow-hidden shadow-[0_0_20px_rgba(0,0,0,0.3)]">
    <img src="{{ asset('pinkies/bg-pinkies.png') }}" class="w-[190px] h-[500px] opacity-80 z-10" />

    <div class="absolute z-[30] top-[12px] left-[2px] pointer-events-none">
        <img src="{{ asset('pinkies/pinkies1.png') }}" alt="Logo" class="h-[130px] w-auto">
    </div>

    <div class="absolute z-[30] top-[11px] left-[5px] pointer-events-none">
        <img src="{{ asset('pinkies/pinkies2.png') }}" alt="Logo" class="h-[130px] w-auto">
    </div>
    <!-- First Photo Slot -->
    ...
    <div class="absolute z-[30] top-[145px] left-[2px] pointer-events-none">
        <img src="{{ asset('pinkies/pinkies3.png') }}" alt="Logo" class="h-[130px] w-auto ">
    </div>
    ...
    <div class="absolute z-[30] bottom-[95px] left-[2px] pointer-events-none">
        <img src="{{ asset('pinkies/pinkies1.png') }}" alt="Logo" class="h-[130px] w-auto">
    </div>
    <div class="absolute z-[30] bottom-[95px] left-[5px] pointer-events-none">
        <img src="{{ asset('pinkies/pinkies2.png') }}" alt="Logo" class="h-[130px] w-auto ">
    </div>
