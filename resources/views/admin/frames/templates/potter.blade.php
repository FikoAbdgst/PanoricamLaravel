<div class="w-full h-full relative bg- overflow-hidden shadow-[0_0_20px_rgba(0,0,0,0.3)]">
    <img src="{{ asset('harrypoter/bgharry.jpg') }}" 
    ...
    <div class="absolute z-[30] bottom-[360px] left-2 w-full text-center pointer-events-none">
        <img src="{{ asset('harrypoter/harry3.png') }}" alt="Nj1" style="transform: translateX(-55px);" class="h-[130px] w-auto">
    </div>

    <div class="absolute z-[30] bottom-[350px] left-2 w-full text-center pointer-events-none">
        <img src="{{ asset('harrypoter/harry1.png') }}" alt="Nj2" style="transform: translateX(125px);" class="h-[50px] w-auto">
    </div>

    <div class="absolute z-[30] bottom-[180px] left-2 w-full text-center pointer-events-none">
        <img src="{{ asset('harrypoter/harry6.png') }}" alt="Nj3" style="transform: translateX(-20px);" class="h-[110px] w-auto">
    </div>

        <div class="absolute z-[30] bottom-[450px] left-2 w-full text-center pointer-events-none">
        <img src="{{ asset('harrypoter/harry4.png') }}" alt="Nj3" style="transform: translateX(145px);" class="h-[30px] w-auto">
    </div>
