<div class="w-full h-full relative bg-white overflow-hidden shadow-[0_0_20px_rgba(0,0,0,0.3)]">
    <img src="{{ asset('winnie/bg-winnie.png') }}" class="w-[190px] h-[500px] opacity-80 z-10" />

    <div class="absolute z-[30] top-[35px] left-[-15px] pointer-events-none">
        <img src="{{ asset('winnie/winnie1.png') }}" alt="Logo" class="h-[120px] w-auto">
    </div>
    <div class="absolute z-[30] top-[20px] right-[7px] pointer-events-none">
        <img src="{{ asset('winnie/winnie2.png') }}" alt="Logo" class="h-[25px] w-auto">
    </div>
    <!-- First Photo Slot -->
    ...
    <div class="absolute z-[30] top-[180px] right-[-18px] pointer-events-none">
        <img src="{{ asset('winnie/winnie3.png') }}" alt="Logo" class="h-[100px] w-auto">
    </div>
    ...
    <div class="absolute z-[30] bottom-[98px] left-[-20px] pointer-events-none">
        <img src="{{ asset('winnie/winnie4.png') }}" alt="Logo" class="h-[95px] w-auto  ">
    </div>
    <div class="absolute z-[30] bottom-[60px] right-[-5px] pointer-events-none">
        <img src="{{ asset('winnie/winnie5.png') }}" alt="Logo" class="h-[85px] w-auto  ">
    </div>


    <div class=" z-[20] relative bottom-[43px] left-[1px] ">
