<div class="w-full h-full relative bg-overflow-hidden shadow-[0_0_20px_rgba(0,0,0,0.3)]">
    ...
    <div class="absolute z-[30] bottom-[207px] left-2 w-full text-center pointer-events-none">
        <img src="{{ asset('AoT/titankolosal5.png') }}" alt="Nj1" style="transform: translateX(-40px);"
            class="h-[110px] w-auto">
    </div>

    <div class="absolute z-[30] bottom-[90px] left-2 w-full text-center pointer-events-none">
        <img src="{{ asset('AoT/titankolosal3.png') }}" alt="Nj2" style="transform: translateX(110px);"
            class="h-[95px] w-auto">
    </div>

    <div class="absolute z-[30] bottom-[290px] left-2 w-full text-center pointer-events-none">
        <img src="{{ asset('AoT/titankolosal4.png') }}" alt="Nj2" style="transform: translateX(110px);"
            class="h-[150px] w-auto">
    </div>

    <div class="absolute z-[30] bottom-[425px] left-2 w-full text-center pointer-events-none">
        <img src="{{ asset('AoT/titankolosal2.png') }}" alt="Nj3" style="transform: translateX(-10px);"
            class="h-[80px] w-auto">
    </div>
