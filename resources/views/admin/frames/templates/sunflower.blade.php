<div class="w-full h-full relative bg-white overflow-hidden shadow-[0_0_20px_rgba(0,0,0,0.3)]">
    <img src="{{ asset('sunflow/bg-sunflow.png') }}" class="w-[190px] h-[500px] opacity-80 z-10" />

    <div class="absolute z-[30] top-[-3px] left-[3px] pointer-events-none">
        <img src="{{ asset('sunflow/sunflow1.png') }}" alt="Logo" class="h-[60px] w-auto">
    </div>
    <div class="absolute z-[30] top-[-20px] right-[-25px] pointer-events-none">
        <img src="{{ asset('sunflow/sunflow2.png') }}" alt="Logo" class="h-[90px] w-auto">
    </div>
    <!-- First Photo Slot -->
