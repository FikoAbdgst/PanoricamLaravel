<div class="w-full h-full relative bg-white overflow-hidden shadow-[0_0_20px_rgba(0,0,0,0.3)]">
    <img src="{{ asset('roses/bg-roses.png') }}" class="w-[190px] h-[500px] opacity-80 z-10" />
    ...
    <div class="absolute z-[30] top-[11px] left-[-5px] pointer-events-none">
        <img src="{{ asset('roses/roses3.png') }}" alt="Logo" class="h-[50px] w-auto">
    </div>
    <!-- First Photo Slot -->
    ...
    <div class="absolute z-[30] top-[145px] right-[-2px] pointer-events-none">
        <img src="{{ asset('roses/roses2.png') }}" alt="Logo" class="h-[50px] w-auto ">
    </div>
    ...
    <div class="absolute z-[30] bottom-[170px] left-[-5px] pointer-events-none">
        <img src="{{ asset('roses/roses3.png') }}" alt="Logo" class="h-[50px] w-auto ">
    </div>
